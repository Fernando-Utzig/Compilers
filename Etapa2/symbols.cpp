...
"SYMBOL_VARIABLE", "SYMBOL_FUNCTION", "SYMBOL_VECTOR"
};
...
SYMBOL *symbolInsert(int type, const char *text) {
    ...
    switch (type) {
        ...
        case 20:            enumType = SYMBOL_VARIABLE; break;
        case 21:            enumType = SYMBOL_VECTOR; break;
        case 22:            enumType = SYMBOL_FUNCTION; break;
